...
pcie_addrs = ["c1:00.0", "c1:00.1", "03:00.0", "03:00.1"]
...
output_file_format = "/home/cxz/result/dma_copy_2.7.0_new/{}_p{}_b{}_t{}_{}_{}"
...
payload = [1024, 2048, 4096, 8192, 16384, 32768]
...
def make_and_clean(ssh, item_index, extra_flag=""):
    stdin, stdout, stderr = ssh.exec_command(
        "cd {0}  && echo dma_copy_bench > {0}/test_suite/build_app && rm -rf ./build && mkdir build && cd build && {2} cmake .. {1} && make -j".format(
            base,
            extra_flag,
