...
extern "C"
{
    flexio_func_t dpa_refactor_workingset_device_event_handler;
    flexio_func_t dpa_refactor_workingset_device_init;
    extern struct flexio_app *dpa_refactor_workingset_device;
}
...
class dpa_refactor_workingset_config {
public:
