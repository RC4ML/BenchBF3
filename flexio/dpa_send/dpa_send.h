...
extern "C"
{
    flexio_func_t dpa_send_device_event_handler;
    flexio_func_t dpa_send_device_init;
    flexio_func_t dpa_send_deivce_first_packet;
    extern struct flexio_app *dpa_send_device;
}

DECLARE_string(device_name);

class dpa_send_config {
public:
