...
#define HZ 1800000000
#define Too_Small_Time (HZ/10)
#define CLOCK_TYPE "__dpa_thread_cycles()"
#define Start_Timer() Begin_Time = __dpa_thread_cycles()
#define Stop_Timer() End_Time = __dpa_thread_cycles()
