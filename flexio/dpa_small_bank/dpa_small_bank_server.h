...
extern "C"
{
    flexio_func_t dpa_small_bank_server_device_init;
    flexio_func_t dpa_small_bank_server_device_event_handler;
    extern struct flexio_app *dpa_small_bank_server_device;
}

#define TARGET_MAC 0x010101010101

class dpa_small_bank_server_config {
public:
    FLEX::CQ *rq_cq;
    FLEX::CQ *sq_cq;
    FLEX::SQ *sq;
